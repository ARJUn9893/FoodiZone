...
public class Registeration extends AppCompatActivity {
    ...
    TextInputLayout fname, lname, localadd, emaill, pass, cmpass, Mobileno,cpincode,carea;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            carea = (TextInputLayout) findViewById(R.id.Area);
            cpincode = (TextInputLayout) findViewById(R.id.Pincode);
            ...
            Signin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    pincode = cpincode.getEditText().getText().toString().trim();
                    area = carea.getEditText().getText().toString().trim();
