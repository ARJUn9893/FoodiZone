...
public class Delivery_registeration extends AppCompatActivity {
    ...
    TextInputLayout Fname, Lname, Pass, cfpass, mobileno, houseno, area, pincode, Email;
    ...
    String statee, cityy,  fname, lname, mobile, confirmpassword, password, Area, Pincode, house, emailid;
                                                            ...
                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                   ...
                                                                   // Intent b = new Intent(Delivery_registeration.this, Delivery_VerifyPhone.class);
                                                                    // later remove delivery login and add delivery verify phone above line
    ...
    public boolean isValid() {
        ...
        boolean isValidname = false, isvalidpassword = false, isValidemail = false, isvalidconfirmpassword = false, isvalid = false, isvalidmobileno = false, isvalidlname = false, isvalidhousestreetno = false, isvalidarea = false, isvalidpincode = false;
        ...
        isvalid = (isValidname && isvalidpincode && isValidemail && isvalidlname && isvalidconfirmpassword && isvalidpassword && isvalidmobileno && isvalidarea && isvalidhousestreetno) ? true : false;
        return isvalid;
